...
public class SearchShopBannerTestData {
	
	
	    
			    
		@DataProvider(name = "shopBannerTest")
		public static Object [][] shopBannerTest() throws Exception {
			
			String description = "case1:获取找店页的banner，没有入参，看返回code且图片链接";
...
//			query.put("sign", gensign());//怎么生成
			query.put("token", "XIANMAOTEST");


			
			return new Object[][]{
					{description, query, 200, 1, 200},
