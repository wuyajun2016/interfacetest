...
public class FireMemberTestData {
	
	
	    
			    
		@DataProvider(name = "fireMemberTest")
		public static Object [][] fireMemberTest() throws Exception {
			
			String description = "case1:没有入参，检查返回200,data有值";
