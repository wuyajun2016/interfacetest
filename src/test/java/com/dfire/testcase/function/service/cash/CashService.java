package com.dfire.testcase.function.service.cash;
...
public class CashService {
	...
	private ServiceBillVO createServiceBillVO(List<Instance> instances,TotalPayInfoVo totalPayInfoVo) {
		...
		serviceBillVO.setOriginTotal(fee);  // add by wenjing
	...
	public Map<String, Object> approveOrder(HttpRequestEx cashRequest,Map<String, String> cashMap,String entityId, String appSecret) throws Exception{
	 ...
	 * @param appSecret
	 */
	public void settleAccounts(HttpRequestEx cashRequest,BaseParamBean baseParam, Map<String, String> cashMap,String appSecret){
...
//	}
	...
	public void preSettleAccounts(HttpRequestEx cashRequest,Map<String, String> cashMap,BaseParamBean baseParamBean, String appSecret) throws JsonParseException, JsonMappingException, IOException{
		...
		//获取返回值	
		String waitingOrderId = baseParamBean.getWaitingOrderId();
		String json = String.valueOf(JSONPath.read(response.getResponseStr(), "$.data[b_id='"+waitingOrderId+"'][0]"));//获取特定json
	...
	private void preEndPay(HttpRequestEx cashRequest, String entityId,CloudMessage msg, CustomerPayOrder customerPayOrder,
			String appSecret) {
	 ...
	 * @throws Exception 
	 */
	public String loginwithpassword(HttpRequestEx cashRequest,BaseParamBean baseParamBean, Map<String, String> cashMap, String appSecret) throws Exception {
		String sessionId = "";
		try {
			//收银机登录
			Map<String, String> parMap = new HashMap<String, String>();
	 ...
	 * @throws Exception 
	 */
	public void heart(HttpRequestEx cashRequest, BaseParamBean baseParamBean,
			Map<String, String> cashMap, String appSecret) throws Exception {
		
		Map<String, String> parMap = new HashMap<String, String>();
		parMap.put("entityid", baseParamBean.getEntityId());
		parMap.put("apptime", String.valueOf(System.currentTimeMillis()));
		 
		String sign = SignUtil.heartSign(parMap, appSecret);
		parMap.put("sign", sign);
...
//		CloudMessage msg = JSONObject.parseObject(json,CloudMessage.class);
	...
	public void setCashInitBean() {
		...
		cashinitBean.setS_eid(propertyUtil.getValue("s_eid"));
